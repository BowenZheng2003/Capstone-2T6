...
prompt = (
    ...
    "<Matcha presentation>. Provide helpful feedback on the following: whether the tone of voice, "
...
with open("backend/final_report_generation/merged.json", "r", encoding="utf-8") as f:
    json_string = f.read()
